...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        const rslt = {
            result:result.rows,
            result1:result1.outBinds.reslt1,
            reslt:reslt.rows,
        }
...
app.post('/showdetails', async (req, res) => {
    ...
    try {
        ...
        WHERE P.ID = :idval AND  I.IMG_URL LIKE '%img1.jpg' AND (S.ATTR_NAME  IN ('Supported SSD Type','USB','Display','Graphics_Card','HDMI','LAN','Weight','Wi-Fi','Keyboard') OR S.ATTR_NAME IS NULL )
