...
<Table responsive striped hover bordered={true} className="text-center mt-5">
              <thead>
                <tr>
                  <th style={{ backgroundColor: 'turquoise' }}>PURCHASE ID</th>
                  <th style={{ backgroundColor: 'turquoise' }}>PRODUCT NAME</th>
                  <th style={{ backgroundColor: 'turquoise' }}>PURCHASE DATE</th>
                  <th style={{ backgroundColor: 'turquoise' }}>PAYMENT INFO</th>
                  <th style={{ backgroundColor: 'turquoise' }}>CUSTOMER NAME</th>
                  <th style={{ backgroundColor: 'turquoise' }}>PRODUCT QUANTITY</th>
                  <th style={{ backgroundColor: 'turquoise' }}>APPROVE</th>
                </tr>
              </thead>
              <tbody>
                {pending.length > 0 ? (
