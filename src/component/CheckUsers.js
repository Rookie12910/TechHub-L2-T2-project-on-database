          ...
          <Card className='mt-2 border-0 rounded-0 shadow-sm'>
            <CardBody style={{ backgroundColor: '#696969' }}>
              ...
              <Table responsive striped hover bordered={true} className='text-center mt-5'>
                <tbody>
                  <tr>
                    <td style={{ backgroundColor: 'turquoise' }}>USER ID</td>
                    <td style={{ backgroundColor: 'turquoise' }}>NAME</td>
                    <td style={{ backgroundColor: 'turquoise' }}>EMAIL</td>
                    <td style={{ backgroundColor: 'turquoise' }}>PHONE NUMBER</td>
                    <td style={{ backgroundColor: 'turquoise' }}>ADDRESS</td>
                    <td style={{ backgroundColor: 'turquoise' }}>ROLE</td>
                    <td style={{ backgroundColor: 'turquoise' }}>OPERATION</td>
                  </tr>
